// To parse this data:
//
//   import { Convert, SearcGifsResponse } from "./file";
//
//   const searcGifsResponse = Convert.toSearcGifsResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearcGifsResponse {
    data:       Gif[];
...
export class Convert {
    public static toSearcGifsResponse(json: string): SearcGifsResponse {
        return cast(JSON.parse(json), r("SearcGifsResponse"));
    }

    public static searcGifsResponseToJson(value: SearcGifsResponse): string {
        return JSON.stringify(uncast(value, r("SearcGifsResponse")), null, 2);
    }
}
